...
class _ApiClient implements ApiClient {
  ...
  @override
  Future<LoginResponse> authLogin(LoginBody body) async {
  ...
  @override
  Future<GoogleSignInResponse> googleLogin(GoogleSignInBody body) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<GoogleSignInResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = GoogleSignInResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<ListMoviesResponse> getMovies(int page) async {
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<ListMoviesResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = ListMoviesResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<UploadPhotoResponse> uploadProfilePhoto(File file) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<UploadPhotoResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
