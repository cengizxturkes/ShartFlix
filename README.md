...
* [x] Keşfet
* [x] Register
* [x] HomePage(İstenilen özellik ekranda en az5 film gözükmesi gerekiyordan dolayı homepage özelleştirilip ayrı bir keşfet saytfası yapılmıştır.)
* [x] Keşfet
* [x] Film Detay(Movie Detail.)
* [x] Custom Theme
...
* [x] Localization(translate service)
* [x] Bloc StateManagement
* [x] Profil Fotoğrafı Yükleme Özelliği
* [x] Favori Film Listeleme


## :grey_question: FAQ

- Uygulama içerisindeki Clarity Nedir?
...
Project Link: [https://github.com/cengizxturkes/ShartFlix](https://github.com/cengizxturkes/ShartFlix)
