...
class PhotoViewArguments {
  ...
  PhotoViewArguments({required this.images});
}
...
class PhotoViewPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: PhotoViewChildPage(images: arguments.images),
    );
  }
}
...
class PhotoViewChildPage extends StatefulWidget {
  ...
  const PhotoViewChildPage({super.key, required this.images});
...
class _PhotoViewChildPageState extends State<PhotoViewChildPage> {
  ...
  @override
  Widget build(BuildContext context) {
    return Scaffold(backgroundColor: Colors.black, body: _buildBodyWidget());
  }
